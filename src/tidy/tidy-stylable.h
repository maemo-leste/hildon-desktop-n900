...
struct _TidyStylableIface {
	...
	void (*set_style)(TidyStylable * stylable, TidyStyle * style);

	/* signals, not vfuncs */
	void (*style_notify)(TidyStylable * stylable, GParamSpec * pspec);

	void (*style_set)(TidyStylable * stylable, TidyStyle * old_style);
};
...
void tidy_stylable_set(TidyStylable * stylable, const gchar * first_property_name, ...) G_GNUC_NULL_TERMINATED;
void tidy_stylable_get(TidyStylable * stylable, const gchar * first_property_name, ...) G_GNUC_NULL_TERMINATED;
