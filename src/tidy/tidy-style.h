...
void tidy_style_set_effectv(TidyStyle * style,
			    ...
			    ClutterAlphaFunc alpha_func, guint n_parameters, GParameter * parameters);
void tidy_style_set_effect(TidyStyle * style,
			   const gchar * effect_name,
			   guint duration,
			   GType behaviour_type,
			   ClutterAlphaFunc alpha_func, const gchar * first_property_name, ...) G_GNUC_NULL_TERMINATED;
