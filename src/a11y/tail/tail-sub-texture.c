...
/* GObject */
static void tail_sub_texture_class_init(TailSubTextureClass * klass);

static void tail_sub_texture_init(TailSubTexture * root);

/* AtkObject.h */

static void tail_sub_texture_initialize(AtkObject * obj, gpointer data);

static const gchar *tail_sub_texture_get_description(AtkObject * obj);
...
static void tail_sub_texture_init(TailSubTexture * tile)
{
	/* nothing required */
}
...
static void tail_sub_texture_initialize(AtkObject * obj, gpointer data)
{
	...
	handler_id = g_signal_handler_find(actor, G_SIGNAL_MATCH_ID, signal_id, 0, NULL, NULL, NULL);
