...
static void hd_status_menu_realize(MBWindowManagerClient * client);

static void hd_status_menu_class_init(MBWMObjectClass * klass)
{
...
static void hd_status_menu_destroy(MBWMObject * this)
{
...
static int hd_status_menu_init(MBWMObject * this, va_list vap)
{
	MBWindowManagerClient *client = MB_WM_CLIENT(this);

	mb_wm_client_set_layout_hints(client, LayoutPrefFixedX | LayoutPrefVisible);
