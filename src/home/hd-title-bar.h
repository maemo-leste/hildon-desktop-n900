...
typedef enum {
	...
	HDTB_VIS_BTN_LEFT_MASK = HDTB_VIS_BTN_LAUNCHER | HDTB_VIS_BTN_SWITCHER | HDTB_VIS_BTN_MENU,
	HDTB_VIS_BTN_RIGHT_MASK = HDTB_VIS_BTN_BACK | HDTB_VIS_BTN_CLOSE | HDTB_VIS_BTN_DONE,
} HdTitleBarVisEnum;
...
ClutterActor *hd_title_bar_create_fake(gboolean portrait);
